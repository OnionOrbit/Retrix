...
// Accepts optional username for offline/cracked launch
export async function run(path, username) {
	if (username) {
		return await invoke('plugin:profile|profile_run', { path, username })
	} else {

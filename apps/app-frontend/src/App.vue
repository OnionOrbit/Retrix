	...
	<div v-if="stateInitialized" class="app-grid-layout experimental-styles-within relative">
		...
		<div data-tauri-drag-region class="app-grid-statusbar bg-bg-raised h-[--top-bar-height] flex">
			<div data-tauri-drag-region class="flex p-3">
				<!-- TODO: Replace with Retrix logo if available -->
	...
	>
		<div class="app-viewport flex-grow router-view">
			<transition name="popup-survey">
				...
				>
					<h2 class="text-lg font-extrabold mt-0 mb-2">Hey there Retrix user!</h2>
					<p class="m-0 leading-tight">
						Would you mind answering a few questions about your experience with Retrix?
					</p>
					<p class="mt-3 mb-4 leading-tight">
						This feedback will go directly to the Retrix team and help guide future updates!
					</p>
